...
var update = __webpack_require__(93)("fb7de952", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-1aabd4c0\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./plugins.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-1aabd4c0\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./plugins.vue");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_js_modal__ = __webpack_require__(1097);
      ...
      [
        _c(
          "b-card",
          {
            ...
            attrs: { header: "Plugins", "header-tag": "h4" }
          },
          [
                  ...
                  _c("div", { staticClass: "col-lg-4" }, [
                    _c(
                      ...
                      [
                        ...
                        _vm._v(" "),
                        _vm._l(_vm.model.pluginsdata, function(plugin) {
                          return _c("input", {
                            directives: [
                              {
                                name: "model",
                                ...
                                expression: "plugin.plugin_id"
                              }
                            ],
                            attrs: { name: "plugin_id[]", type: "hidden" },
                            domProps: { value: plugin.plugin_id },
                            on: {
                        ...
                        _vm._l(_vm.model.pluginsdata, function(plugin) {
                          return _c("input", {
                            ...
                            domProps: { value: plugin.plugin_name },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                      ...
                      [
                        ...
                        _vm._l(_vm.model.pluginsdata, function(plugin) {
                          return _c("input", {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: plugin.plugin_price,
                                expression: "plugin.plugin_price"
                              }
                            ],
                            staticClass: "form-control",
                            attrs: {
                            ...
                            domProps: { value: plugin.plugin_price },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                      ...
                      [
                        ...
                        _vm._l(_vm.model.pluginsdata, function(plugin) {
                          return _c("input", {
                            directives: [
                              {
                                ...
                                expression: "plugin.plugin_status"
                              }
                            ],
                            staticClass: "form-control",
                            attrs: {
                            ...
                            domProps: { value: plugin.plugin_status },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-1aabd4c0", module.exports)
  }
}
...
/* scopeId */
var __vue_scopeId__ = "data-v-1aabd4c0"
...
Component.options.__file = "resources/assets/components/pages/plugins.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1aabd4c0", Component.options)
  } else {
    hotAPI.reload("data-v-1aabd4c0", Component.options)
  }
