...
var update = __webpack_require__(93)("5d67dab9", content, false, {});
    ...
    methods: {
        onSubmit: function onSubmit() {
            ...
            if (vm.formstate.$invalid) {
                ...
                axios.post('./oauth/token', vm.model).then(function (response) {
      ...
      _c("div", { staticClass: "col-sm-12" }, [
        _c("div", { staticClass: "text-center" }, [
          _c("img", {
            ...
            attrs: { src: __webpack_require__(1707) }
          })
        ])
      ])
    ])
...
module.exports = "/cheerspos/images/login_user-01.png?7bcbdbdc40b938259be7fa075d209095";
