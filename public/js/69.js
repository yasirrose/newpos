...
var update = __webpack_require__(92)("5a87c5ce", content, false, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_components_widgets_chat_component_chat_large_vue__ = __webpack_require__(1332);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_assets_js_chat_data__ = __webpack_require__(914);
//
//
//
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(92)("1bc29de5", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__plugins_scroll_vScroll_vue__ = __webpack_require__(791);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            ...
            bgColor: __webpack_require__(849),
            className: '',
            newmessage: '',
            ...
            _c("div", { staticClass: "float-right" }, [
                ...
                _c("input", {
                  ...
                  on: {
                    change: function($event) {
                      _vm.bgColor = __webpack_require__(849)
                    }
                  }
                })
              ]),
              ...
              _c("label", { staticClass: "bg2" }, [
                _c("input", {
                  ...
                  on: {
                    change: function($event) {
                      _vm.bgColor = __webpack_require__(889)
                    }
                  }
                })
              ]),
    ...
    return _c("div", { staticClass: "attachments text-left p-4" }, [
      ...
      _c("div", { staticClass: "row" }, [
        ...
        _c("div", { staticClass: "col-4 mt-2" }, [
          _c("img", {
            staticClass: "img-fluid",
            attrs: { src: __webpack_require__(921), alt: "" }
          })
        ])
      ])
    ])
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(92)("f52879c2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
